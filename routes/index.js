...
setInterval( function setup() {
  ...
  connection.query(sqlsss, function (err, ListflagData) {
	...
	if(a == "01:00"|| a == "01:15"|| a == "01:30"|| a == "01:45"||a == "02:00"|| a == "02:15"|| a == "02:30"|| a == "02:45"||a == "03:00"|| a == "03:15"|| a == "03:30"|| a == "03:45"||a == "04:00"|| a == "04:15"|| a == "04:30"|| a == "04:45"||a == "05:00"|| a == "05:15"|| a == "05:30"|| a == "05:45"||a == "06:00"|| a == "06:15"|| a == "06:30"|| a == "06:45"||a == "07:00"|| a == "07:15"|| a == "07:30"|| a == "07:45"||a == "08:00"|| a == "08:15"|| a == "08:30"|| a == "08:45"|| a == "09:00"|| a == "09:15"|| a == "09:30"|| a == "09:45"|| a == "10:00"|| a == "10:15"|| a == "10:30"|| a == "10:45"|| a == "11:00"|| a == "11:15"|| a == "11:30"|| a == "11:45"|| a == "12:00"|| a == "12:15"|| a == "12:30"|| a == "12:45"|| a == "13:00"|| a == "13:15"|| a == "13:30"|| a == "13:45"|| a == "14:00"|| a == "14:15"|| a == "14:30"|| a == "14:45"|| a == "15:00"|| a == "15:15"|| a == "15:30"|| a == "15:45"|| a == "16:00"|| a == "16:15"|| a == "16:30"|| a == "16:45"|| a == "17:00"|| a == "17:15"|| a == "17:30"|| a == "17:45"|| a == "18:00"|| a == "18:15"|| a == "18:30"|| a == "18:45"|| a == "19:00"|| a == "19:15"|| a == "19:30"|| a == "19:45"|| a == "20:00"|| a == "20:15"|| a == "20:30"|| a == "20:45"|| a == "21:00"|| a == "21:15"|| a == "21:30"|| a == "21:45"|| a == "22:00"|| a == "22:15"|| a == "22:30"|| a == "22:45"|| a == "23:00"|| a == "23:15"|| a == "23:30"|| a == "23:58"){
        //  whatsapp_posts3(a);
        //  whatsapp_posts4(a);
         autopostcraftFunction(ListflagData,finalPostList,'pcrafts01-21');
         autopostdealshareFunction(ListflagData,finalPostList,'dealshare06-21');
...
async function autopostFunction(ListflagData,grouplist,tag) {  
  var finalTextValue1 = getRandomArbitrary(1,11000)
   let search = 'amazon';
  await request({
    uri: `https://backend.top9deals.com/admin/address/listamznproducts1?start=`+finalTextValue1+`&length=20`,
    method: "GET",
  }, (err, response, body) => {
...
//         for (let l = 0; l < grouplist.length; l++) {
          ...
          telePostWeb(ListflagData[0].kudart_token,"-1001363967536",post.desk_img,post.product_title,response.body)
//         }
      })
    } 
...
async function autopostcraftFunction(ListflagData,grouplist,tag) {  
  var finalTextValue1 = getRandomArbitrary(1,11040)
   let search = 'amazon';
  await request({
    uri: `https://backend.top9deals.com/admin/address/listamznproducts1?start=`+finalTextValue1+`&length=20`,
    method: "GET",
    ...
    let post = JSON.parse(response.body).data.list[1];
    let bitly = new BitlyClient(ListflagData[0].current_bitly);
      let dflink = 'https://offerzoneindia.com/products/'+post.desk_cate+'/'+post.desk_sub_cate+'/'+post.desk_mini_sub_cate+'/'+post.id;
      tinyUrl2('https://offerzoneindia.com/products/'+post.desk_cate+'/'+post.desk_sub_cate+'/'+post.desk_mini_sub_cate+'/'+post.id)
    ...
    async function tinyUrl2(url) {  
      await request({
        ...
        telePostWeb1(ListflagData[0].kudart_token,"@Offerzoneindia0",post.desk_img,post.product_title,response.body)
      })
    }  
...
async function autopostdealshareFunction(ListflagData,grouplist,tag) {  
  var finalTextValue1 = getRandomArbitrary(1,11040)
   let search = 'amazon';
  await request({
    uri: `https://backend.top9deals.com/admin/address/listamznproducts1?start=`+finalTextValue1+`&length=20`,
    ...
    let post = JSON.parse(response.body).data.list[1];
    let bitly = new BitlyClient(ListflagData[0].current_bitly);
      let dflink = 'https://offertech.in/products/'+post.desk_cate+'/'+post.desk_sub_cate+'/'+post.desk_mini_sub_cate+'/'+post.id;
      tinyUrl2('https://offertech.in/products/'+post.desk_cate+'/'+post.desk_sub_cate+'/'+post.desk_mini_sub_cate+'/'+post.id)
    ...
    async function tinyUrl2(url) {  
      await request({
        ...
        telePostWeb1(ListflagData[0].kudart_token,"@offertech_india",post.desk_img,post.product_title,response.body)
        telePostWeb(ListflagData[0].kudart_token,"-1001363693844",post.desk_img,post.product_title,response.body)
      })
    }  	  
  })
}

function telePostWeb1 (token,chennalName,post_img,post_title,post_link) {
...
function postImageWidth(post_link,token,amzn_data,storeId,finalAmznData,telegroup,teleFlag,wattsflag,finalIdList,randomTagSelect) {
  ...
  axios(post_link)
      .then(response => {
          ...
          let sqlss = "INSERT INTO post_telegram7 (post_id,data) VALUES (" + storeId + ",'demo')";
...
//       axios('https://t.me/s/stg003')
      // axios('https://t.me/s/HotDealsOfficials')
        .then(response => {
          ...
          let sql = 'SELECT COUNT(*) as cnt FROM post_telegram7 WHERE post_telegram7.post_id =' + last_insert_id.id;
    ...
    function posttele (bodyss, lastInsertId, lastArrayData) {
      ...
      // }, (err, response, body) => {
        ...
        let finalPostList1 = JSON.parse(ListflagData.all_tele_group).telenogroup;
        // let finalPostList = JSON.parse(ListflagData.all_tele_group4).telenogroup;
        // let finalPostList1 = JSON.parse(ListflagData.all_tele_group3).telenogroup;
        let sqls = "SELECT post_id FROM post_telegram7 ORDER BY id DESC LIMIT 1";
          ...
          for (let i = 0; i < lastInsertId - rides[0].post_id; i++) {
            ...
            let userExists = lastArrayData.filter(user => user.id == nextId);
              ...
              //  makePostReady(userExists,ListflagData,'salebaba-21',finalPostList,nextId)
               makePostReady(userExists,ListflagData,'kudrats-21',finalPostList1,nextId)
            }else{
              let sqlss = "INSERT INTO post_telegram7 (post_id,data) VALUES (" + nextId + ",'demo')";
              connection.query(sqlss, function (err, rides) {
                if (err) {
                console.log('err: ', err);
                }
...
function makePostReady(userExists,ListflagData,randomTagSelect,finalPostList,nextId){
    ...
    if (randomTagSelect == 'salebaba-21') {
        ...
        finalTextValue1 = getRandomArbitrary(1,11040);
...
router.post('/getAllInOneData', function (req, res) {
  ...
  async.waterfall([
    function (nextCall) {
      ...
      connection.query(sql, ['post_telegram7'], function (err, rides) {
        if (err) {
          return nextCall({
      ...
      connection.query(query, ["post_telegram7", LimitNum, startNum], function (err, ridess) {
        if (err) {
          return nextCall({
            "message": "something went wrong",
          });
